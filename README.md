...
|Go Services|Graceful shutdown: <br>1) Останавливаем приём новых задач; <br>2) Даем время на завершение активных запросов; <br>3) Дожидаемся окончания работы всех горутин; <br>4) Завершаем работу сервиса.|
